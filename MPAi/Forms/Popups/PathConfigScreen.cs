    ...
    public partial class SystemConfig : Form
    {
        ...
        public void InitializeContent()
        {
            try
            {
                ...
                // Formant folder.
                InitializeTextBox(this.formantFolderTextBox, DirectoryManagement.FormantFolder);
            }
            catch(Exception exp)
            {
        ...
        private void videoFolderSelectButton_Click(object sender, EventArgs e)
        {
            if (folderBrowserDialog.ShowDialog() == DialogResult.OK)
            {
                videoFolderTextBox.Text = folderBrowserDialog.SelectedPath;
            }
        }
        /// <summary>
        ...
        private void formantFolderSelectButton_Click(object sender, EventArgs e)
        {
            if (folderBrowserDialog.ShowDialog() == DialogResult.OK)
            {
                formantFolderTextBox.Text = folderBrowserDialog.SelectedPath;
            }
        }
