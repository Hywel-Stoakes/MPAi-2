...
FRAMEWIDTH = DEFAULTHEIGHT#round(DEFAULTHEIGHT * SIZERATIO) #Calculates the correct width from height.
...
class VowelApp:
    ...
    def __init__(self):
        ...
        if len(sys.argv) == 3:
            ...
            try:
                ...
                print 'for Testing, setting you to masculine and heritage'
                voiceType = 'masculine'
                langType = 'heritage'
        ...
        self.loadVowelPlot(self.id, self.vowel)
    ...
    """
    Handles the redrawing of the target upon a resize.
    """
    def onResize(self,event):
        #TODO make the target resizeable.
        pass
    ...
    """
    def loadVowelPlot(self, id, vowel):
        self.killFramesChildren()
        self.vowelPlot = VowelPlot(self.frame, self.getAppPathName(), self.root, id, self, vowel, FRAMEWIDTH, FRAMEHEIGHT )
