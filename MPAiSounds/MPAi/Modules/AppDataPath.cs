...
namespace MPAi.Modules
{
    ...
    class AppDataPath
    {
        ...
        /// </summary>
        private readonly static string temp = System.IO.Path.Combine(System.Environment.GetEnvironmentVariable("TEMP"), "MPAiTemp", "MPAiSounds");

        /// <summary>
        /// Combination of the standard MPAi directory, and a folder which will always be called App_Data.
        /// </summary>
        private readonly static string path = System.IO.Path.Combine(System.Environment.GetEnvironmentVariable("appdata"), "MPAi", "MPAiSounds");
